package Minikin.Objects.Enemies 
{
	 ...
	 * @author Nick Heckman
	 */
	public class SlimePink extends Enemy 
	{
		public var mAttackTimer:Timer;
		public var mIsHurt:Boolean;
		
		public function SlimePink() 
		{
			super();
			
			mSprite = new Spritemap(ImageManager.IMG_SLIME_PINK, 16, 16);
			mSprite.add("Stand", [0]);
			...
			mAttackTimer = new Timer(Math.random() * 2000 + 2000, 0);
		...
		private function Attack(e:Event):void
		{
			...
			mAttackTimer.reset();
			mAttackTimer.delay = Math.random() * 2000 + 2000;
			mAttackTimer.start();
		}
